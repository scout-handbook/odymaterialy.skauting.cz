...
$endpoint = new OdymaterialyAPI\Endpoint('image');
...
$endpoint->setListMethod(new OdymaterialyAPI\Role('editor'), $listImages);
...
$endpoint->setGetMethod(new OdymaterialyAPI\Role('guest'), $getImage);
...
$endpoint->setAddMethod(new OdymaterialyAPI\Role('editor'), $addImage);
