function addImage()
{
	...
	html += "<div class=\"newButton greenButton\" id=\"addImageSave\"><i class=\"icon-floppy\"></i>Uložit</div>";
	...
	html += "<div class=\"newButton\"><i class=\"icon-upload\"></i>Vybrat soubor</div></label>"
	html += "</div></form>";
